...
<body>
  ...
  <div class="container mande">
    ...
    <div class="row info_movie">
      ...
      <div class="col-lg-4 mb-4">
        <div class="card h-100">
          <div class="card-body" style="background-image:url(img/god.jpg); background-size:cover;">
          <div class="whatmovie">
              <button type="button"><img src="img/good.png" style="width:50px;"></button>
              <button type="button"><img src="img/bad.png" style="width:50px;"></button>
            </div>
      ...
      <div class="col-lg-4 mb-4">
        <div class="card h-100">
          <div class="card-body" style="background-image:url(img/kim1.jpg); background-size:cover;">
          <div class="whatmovie">
              <button type="button"><img src="img/good.png" style="width:50px;"></button>
              <button type="button"><img src="img/bad.png" style="width:50px;"></button>
            </div>
