...
<div class="menus"><a href="./free/list.php"><img src="./img/expected.gif" width="140px" height ="38px" border="0"></a></div>
<div class="menus"><a href="./qna/list.php"><img src="./img/worker_management.gif" width="140px" height ="38px"border="0"></a></div>
<div class="menus"><a href="#"><img src="./img/sales_management.gif" width="140px" height ="38px"onclick="window.open('./survey/survey.php', '','scrollbars=no, toolbars=no,width=180,height=230')" border="0"></a></div>
